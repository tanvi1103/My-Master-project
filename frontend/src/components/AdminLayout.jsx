  ...
  <div className="min-h-screen flex flex-col md:flex-row">
    ...
    <nav className="fixed top-0 left-0 w-full z-30 flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-900 border-b shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <a href="/admin/dashboard" className="text-gray-700 dark:text-gray-200 hover:underline px-2">Dashboard</a>
        <a href="/admin/users" className="text-gray-700 dark:text-gray-200 hover:underline px-2">Users</a>
        <a href="/admin/settings" className="text-gray-700 dark:text-gray-200 hover:underline px-2">Settings</a>
      </div>
      <ThemeToogler />
    </nav>
    ...
    <div
      ref={sidebarRef}
      className={`fixed md:relative z-20 top-0 left-0 h-full w-64 bg-white dark:bg-gray-900 shadow-md transform transition-transform duration-300 ease-in-out
