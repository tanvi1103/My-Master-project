      ...
      <section className="why-login">
        ...
        <div className="why-login-container">
          <div className="why-login-card">
            ...
            <p>
              Monitor your learning journey and see your progress over time.
            </p>
          </div>
          <div className="why-login-card">
          ...
          <div className="why-login-card">
            ...
            <p>
              Customize your learning experience based on your preferences and
              goals.
            </p>
          </div>
        </div>
      ...
      <section className="reviews-section">
        ...
        <div className="reviews-container">
          <div className="review-card">
            <h3>Akash Singh</h3>
            <p>
              "This platform has transformed my learning experience. Highly
              recommend!"
            </p>
          </div>
          <div className="review-card">
