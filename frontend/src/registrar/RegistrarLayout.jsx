...
import { FiHome, FiUsers, FiFileText, FiSettings, FiMenu, FiX, FiSun, FiMoon } from 'react-icons/fi';
  ...
  return (
    <div className={`flex flex-col min-h-screen ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside 
          id="sidebar"
          className={`fixed md:relative z-20 w-64 min-h-full bg-white dark:bg-gray-800 shadow-md transform transition-transform duration-300 ease-in-out 
          ...
          <div className="h-full flex flex-col">
            ...
            <nav className="flex-1 px-4 py-6">
              <ul className="space-y-2">
                <li>
                  <a href="#" className="flex items-center px-4 py-3 rounded-lg bg-blue-100 dark:bg-gray-700 text-blue-600 dark:text-blue-300">
                    <FiHome className="mr-3" />
                    <span>Dashboard</span>
                  </a>
                </li>
                <li>
                  <a href="#" className="flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <div className="px-4 py-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Registrar</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-4">
        <div className="container mx-auto px-4 text-center text-gray-600 dark:text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} University Registrar System. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
