...
// import { FaFacebook, FaTwitter, FaLinkedin, FaMapMarkerAlt, FaQuoteLeft } from "react-icons/fa";
...
//       quote: "Bonga University's verification system saved us 60% time in employee credential checks.",
//     },
//     {
//       id: 2,
//       company: "Commercial Bank of Ethiopia",
//       logo: "/cbe-logo.png",
//       quote: "Highly reliable for document authentication. A game-changer for HR processes.",
//     },
//     {
//       id: 3,
//       company: "Awash Bank",
//       logo: "/awash-bank-logo.png",
//       quote: "Integrating this system streamlined our graduate recruitment verification.",
//     },
//   ];
...
//             <Link to="/verify" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Verify</Link>
...
//               <Link to="/" className="py-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Home</Link>
//               <Link to="/verify" className="py-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Verify</Link>
//               <Link to="/about" className="py-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">About</Link>
//               <Link to="/contact" className="py-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Contact</Link>
//             </nav>
//           </div>
//         )}
//       </header>
...
//           alt="Bonga University Graduation"
//           className="absolute inset-0 w-full h-full object-cover"
//         />
//         <div className="relative z-20 px-4 text-white max-w-4xl mx-auto">
//           <h1 className="text-4xl md:text-5xl font-bold mb-4">Verify Graduate Credentials Instantly</h1>
//           <p className="text-xl mb-8">
//             Bonga University's secure digital platform for authenticating academic documents.
...
//               <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Submit Document</h3>
//               <p className="text-gray-600 dark:text-gray-300">
//                 Upload or enter the graduate's details to initiate verification.
//               </p>
//             </div>
//             <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md text-center">
//               <div className="bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
//               <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Instant Verification</h3>
//               <p className="text-gray-600 dark:text-gray-300">
...
//               <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Get Results</h3>
//               <p className="text-gray-600 dark:text-gray-300">
...
//               <li><Link to="/verify" className="hover:text-blue-400">Verify Documents</Link></li>
...
//             </div>
//             <div className="flex space-x-4">
//               <a href="https://facebook.com/bongau" target="_blank" rel="noopener noreferrer">
//                 <FaFacebook size={24} className="hover:text-blue-400" />
//               </a>
//               <a href="https://twitter.com/bongau" target="_blank" rel="noopener noreferrer">
//                 <FaTwitter size={24} className="hover:text-blue-400" />
//               </a>
//               <a href="https://linkedin.com/school/bonga-university" target="_blank" rel="noopener noreferrer">
...
//           <p>&copy; {new Date().getFullYear()} Bonga University. All rights reserved.</p>
//         </div>
//       </footer>
//     </div>
//   );
